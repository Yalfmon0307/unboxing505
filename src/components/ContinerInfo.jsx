        ...
        <div className="max-w-4xl mx-auto">
          <div className="border-2 border-[#ffd600] bg-[#181a23] shadow-xl rounded-xl">
            <div className="text-center p-6 pb-0">
              ...
              <div className="text-2xl font-bold mb-1 text-[#ffd600]">Información de Envío Directo</div>
              <div className="text-gray-300 mb-2">Copia estos datos para usar en tus compras online</div>
            </div>
            <div className="space-y-6 p-6 pt-0">
              {/* Address Section */}
              <div className="bg-[#10121a] rounded-lg p-6 border border-[#ffd600]">
                <div className="flex items-center gap-3 mb-4">
                  <MapPin className="w-5 h-5 text-[#ffd600]" />
                  <h3 className="text-lg font-semibold text-[#ffd600]">Dirección de Envío</h3>
                </div>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-[#ffd600] font-medium">Empresa:</span>
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        title="Copiar"
                      >
                        <Copy className="w-4 h-4 text-[#ffd600]" />
                      </button>
                    </div>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[#ffd600] font-medium">Dirección:</span>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-[#ffd600] font-medium">Teléfono:</span>
                    <div className="flex items-center gap-2">
              ...
              <div className="bg-[#10121a] rounded-lg p-6 border border-[#ffd600]">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-[#ffd600]">Horarios de Recepción</h3>
                </div>
                <p className="text-gray-300">{containerData.hours}</p>
              </div>
              {/* Instructions Section */}
              <div className="bg-[#10121a] rounded-lg p-6 border border-[#ffd600]">
                <h3 className="text-lg font-semibold text-[#ffd600] mb-4">Instrucciones Importantes</h3>
                <ul className="space-y-3">
                  {containerData.instructions.map((instruction, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-yellow-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-[#ffd600] text-sm font-bold">{index + 1}</span>
                      </div>
              ...
              <div className="text-center">
                <button
                  ...
                  className="bg-[#ffd600] hover:bg-yellow-500 text-[#10121a] shadow-lg hover:shadow-xl transition-all duration-300 rounded-lg px-6 py-3 text-lg font-semibold flex items-center justify-center"
                >
